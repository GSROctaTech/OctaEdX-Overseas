...
from PySide2.QtWidgets import (QWidget, QVBoxLayout, QTableWidget, QTableWidgetItem, QPushButton, QMessageBox,)
...
class Widget(QWidget):
    def __init__(self, parent=None, **kwargs):
        ...
        for row in range(10):
            for col in range(5):
                self._tableWidget.setItem(row, col, QTableWidgetItem(f"({row+1},{col+1})"))
    ...
    def getSelectedItems(self):
        ...
        QMessageBox.information(self, "Column Value", f"1st Column Value: {firstColValue.text()}")
