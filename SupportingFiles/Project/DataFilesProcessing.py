...
class App(QWidget):
    ...
    def initUI(self):
        ...
        btnSelectFiles.clicked.connect(lambda: self.selectFiles(self))
...
#------------------------------- Change the following block to accomodate File Selection and populate Files Grid -----------------
    def selectFiles(self):
        ...
        try:
            ...
            fileNames, _ = QFileDialog.getOpenFileNames(Form, "Open CSV",
